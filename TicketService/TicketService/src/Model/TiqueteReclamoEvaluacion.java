...
public class TiqueteReclamoEvaluacion extends Tiquete {
    ...
    public TiqueteReclamoEvaluacion(String detallesResolucion, String archivoAdjunto, String tipoPrueba, String detalleReclamo, String nombreArchivo, String carneEstudiante, String nombreEstudiante, String correoEstudiante, String IDGrupo, int IDTiquete) {
        super(carneEstudiante, nombreEstudiante, correoEstudiante, IDGrupo, IDTiquete);
